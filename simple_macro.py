...
class SimpleMacroGUI:
    ...
    def _setup_ui(self):
        ...
        self.record_btn = ttk.Button(
            button_frame2,
            text="🔴 Record",
            command=self._start_recording_dialog
        )
        ...
        # (Removed redundant toggle Record button; keep dialog Record button above)
    ...
    def _set_selected_loops(self):
        ...
        count_text = f"Selected: {len(selection)} step(s)"
    ...
    def _save_macro(self):
        ...
        def save():
            ...
            self.status_label.config(text=f"Saved: {filename.name}")
            dialog.destroy()
    ...
    def _start_quick_record(self):
        ...
        if self.playing:
            ...
            return
        # remember previous topmost state and set window on top for quick record
        try:
    ...
    def _stop_recording_hotkey(self):
        ...
        try:
            ...
            self._stop_recording()
        # restore previous topmost state if set
        try:
